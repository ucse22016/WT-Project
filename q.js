...
const a_1 = document.getElementById("atext");
const b_1 = document.getElementById("btext");
const c_1 = document.getElementById("ctext");
const d_1 = document.getElementById("dtext");
...
function load() {
 ...
 a_1.innerText = currentData.a;
 b_1.innerText = currentData.b;
 c_1.innerText = currentData.c;
 d_1.innerText = currentData.d;
}
